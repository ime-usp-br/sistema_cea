...
class ApplicationForm(forms.Form):
    ...
    modality = forms.ChoiceField(choices=ServiceApplication.Modality.choices, label="Modalidade")
    ...
    contact_phone = forms.CharField(max_length=50, required=False, label="Telefone")
    has_whatsapp = forms.BooleanField(required=False, label="Possui WhatsApp")
    tax_id = forms.CharField(max_length=20, required=False, label="CPF/CNPJ")
    institution_name = forms.CharField(max_length=255, required=False, label="Instituição")
    course_name = forms.CharField(max_length=255, required=False, label="Curso")
    mentor_name = forms.CharField(max_length=255, required=False, label="Orientador(a)")
    ...
    data_already_collected = forms.BooleanField(required=False, label="Dados já coletados")
    data_use_authorization_accepted = forms.BooleanField(required=False, label="Autorização de uso de dados")
    mentor_declaration_accepted = forms.BooleanField(required=False, label="Declaração de ciência do orientador")
